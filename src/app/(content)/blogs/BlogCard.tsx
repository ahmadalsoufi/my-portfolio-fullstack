  ...
  return (
    <>
      <Link href={`/blogs/${blog.slug}`}>
        <div className="cursor-pointer rounded-2xl bg-slate-700 p-10 text-sm text-blue-400 shadow-md transition-transform duration-300 hover:scale-98 dark:bg-slate-800">
          <div>
