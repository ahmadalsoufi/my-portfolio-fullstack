...
const BlogsDetailsPage = () => {
  ...
  return (
    <>
      {blog ? (
        <section className="flex h-full flex-col items-center justify-center bg-slate-50 px-5 py-8 text-center shadow-md sm:m-5 sm:rounded-lg sm:px-10 dark:bg-slate-800 dark:text-slate-100">
